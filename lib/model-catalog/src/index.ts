...
export const MODEL_CATALOG: readonly ModelCatalogEntry[] = [
  ...
  },
  {
    ...
    label: "GPT 5.5 Pro",
    provider: "OpenAI",
    pricing: { input: 22000, output: 132000 },
    context: "1M",
    note: "Baru",
  ...
  },
  {
    ...
    label: "GPT 5.6 Luna",
    provider: "OpenAI",
    pricing: { input: 24000, output: 144000 },
    context: "1M",
    note: "Baru",
    description: "Generasi ke-6 seri GPT. Kecepatan dan efisiensi tinggi untuk berbagai use-case.",
  ...
  },
  {
    ...
    context: "1M",
    note: "Baru",
    description: "GPT-5.6 varian Sol. Seimbang antara kecepatan, kecerdasan, dan biaya.",
    aliases: ["gpt-5.6-sol"],
  },
  {
    id: "gpt-5-6-terra",
    label: "GPT 5.6 Terra",
    provider: "OpenAI",
    pricing: { input: 26000, output: 156000 },
    context: "1M",
    note: "Baru",
