    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-none border-t border-[#e8f0f7] px-6 pb-6 pt-4">
        ...
        <a
          ...
          className="flex h-11 w-full items-center justify-center gap-2.5 rounded-lg border border-[#dbe8f3] bg-white font-medium text-[#172033] shadow-sm transition-all hover:bg-[#f8fafc] hover:shadow"
        >
