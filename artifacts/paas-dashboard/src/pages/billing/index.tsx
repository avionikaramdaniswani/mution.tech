...
import { Wallet, Zap, ArrowUpCircle, Clock, X } from "lucide-react";
      ...
      <div className="space-y-4">
        ...
        >
          ...
          >
            ...
            <p className="text-sm font-semibold">Saldo Kredit</p>
          </div>

          <div className="px-6 py-6 flex items-start justify-between gap-6 flex-wrap">
            <div>
              <p
              ...
              {/* Bar */}
              <div className="mt-4 w-48 h-1.5 rounded-full" style={{ background: "rgba(255,255,255,0.07)" }}>
                <div
            ...
            <Button
              ...
              className="flex-shrink-0 flex items-center gap-2 text-sm font-semibold rounded-xl px-5 py-2.5"
              style={{
